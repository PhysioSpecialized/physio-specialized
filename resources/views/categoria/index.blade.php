        ...
        @foreach ($categorias as $categoria)
            <div class="modal fade" id="editarModal{{ $categoria->id_categoria }}" tabindex="-1"
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="editarModalLabel{{ $categoria->id_categoria }}">Editar
                                Categoria</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                                    ...
                                    <div class="col-md-6">
                                        <fieldset>
                                            ...
                                            <input type="text" name="nombre_categoria" id="nombre_categoria"
                                                class="form-control" value="{{ $categoria->nombre_categoria }}" required>
                                        </fieldset>
                                    </div>
                                    <!-- Color del encabezado -->
                                    <div class="col-md-6">
                                        <fieldset>
                                            <label for="color_encabezado">Color encabezado:</label>
                                            <input type="color" name="color_encabezado" id="color_encabezado"
                                                value="{{ $categoria->color_encabezado }}" class="form-control">
                                        </fieldset>
                                    </div>
                                    <!-- Imagen de la categoria -->
                                    <div class="col-md-12">
                                        <fieldset>
                                            <label for="img_path">Imagen categoria:</label>
                                            <input type="file" accept="image/*" name="img_path" id="img_path"
                                                value="{{ $categoria->img_path }}" class="form-control">
                                        </fieldset>
                                    </div>
