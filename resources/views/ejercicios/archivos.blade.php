            ...
            <tbody class="text-center align-middle">
                @foreach ($ejercicios as $ejercicio)
                    <tr>
                       ...
                       <td>
                        <button class="btn btn-info text-white" data-bs-toggle="modal" data-bs-target="#detalleModal{{ $ejercicio->id_ejercicio }}">
...
@if (!empty($ejercicios))
@foreach ($ejercicios as $ejercicio)
    <div class="modal fade" id="detalleModal{{ $ejercicio->id_ejercicio }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Detalle de Archivos - {{ $ejercicio->nombre }}</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                        ...
                        <div class="row">
                            @foreach ($ejercicio->archivos as $archivo)
                                <div class="col-md-3 mb-3 ms-5">
                                    ...
                                    <button class="btn btn-danger" onclick="eliminarArchivo({{ $archivo->id_contenido }})">
