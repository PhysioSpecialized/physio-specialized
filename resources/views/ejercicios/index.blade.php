...
@section('content')
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editarModal{{ $ejercicio->id_ejercicio }}">
    ...
    @if (!empty($ejercicios))
    @foreach ($ejercicios as $ejercicio)
<div class="modal fade" id="editarModal{{ $ejercicio->id_ejercicio }}" tabindex="-1" aria-labelledby="editarModalLabel{{ $ejercicio->id_ejercicio }}" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal-title fs-5" id="editarModalLabel{{ $ejercicio->id_ejercicio }}">Editar Ejercicio</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                    ...
                    <div class="row gy-2">
                        ...
                        <div class="col-md-6">
                            <fieldset>
                                ...
                                <select name="id_categoria" id="id_categoria" class="form-control">
                                    @foreach ($categorias as $id_categoria => $nombre_categoria)
                                        <option value="{{ $id_categoria }}" {{ $ejercicio->id_categoria == $id_categoria ? 'selected' : '' }}>
                                            {{ $nombre_categoria }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <div class="col-md-6">
                            <fieldset>
                                ...
                                <input type="text" name="nombre" id="nombre" class="form-control" value="{{ $ejercicio->nombre }}">
                            </fieldset>
                        </div>
